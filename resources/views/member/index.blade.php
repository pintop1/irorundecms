...
@section('main_content')
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-md-4 mt-md-2 mb-2">
                                <div class="card">
                                    <div class="seo-fact sbg1">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                            <div class="seofct-icon"><i class="ti-bar-chart"></i> Savings</div>
                            ...
                            <div class="col-md-4 mt-md-2 mb-2">
                                <div class="card">
                                    <div class="seo-fact sbg2">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                            <div class="seofct-icon"><i class="ti-credit-card"></i> Deposit</div>
                            ...
                            <div class="col-md-4 mt-md-2 mb-2">
                                <div class="card">
                                    <div class="seo-fact sbg3">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                            <div class="seofct-icon"><i class="fa fa-cubes"></i> Loans</div>
                    ...
                    <!--<div class="col-lg-8 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">User Saving Statistics</h4>
                    ...
                    <!--<div class="col-lg-4 mt-5">
                        <div class="card h-full">
                            <div class="card-body">
                                <h4 class="header-title">Overall Statistics</h4>
                        ...
                        <div class="card">
                            <div class="card-body bg1">
                                ...
                                <div class="testimonial-carousel owl-carousel">
                                    <div class="tst-item">
                                        <div class="tstu-img">
                                            <img src="dashboard/assets/images/team/team-author1.jpg" alt="author image">
                                        </div>
                                    ...
                                    <div class="tst-item">
                                        <div class="tstu-img">
                                            <img src="dashboard/assets/images/team/team-author2.jpg" alt="author image">
                                        </div>
                                        <div class="tstu-content">
                                            <h4 class="tstu-name">Abel Franecki</h4>
                                            <span class="profsn">Designer</span>
                                    ...
                                    <div class="tst-item">
                                        <div class="tstu-img">
                                            <img src="dashboard/assets/images/team/team-author3.jpg" alt="author image">
                                        </div>
                                        <div class="tstu-content">
                                            <h4 class="tstu-name">Abel Franecki</h4>
                                            <span class="profsn">Designer</span>
