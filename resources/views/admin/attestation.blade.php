...
@section('title') Add Signatures @stop
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="post" enctype="multipart/form-data">
                                    @csrf
                                    <input class="form-control input-rounded mb-2" type="text" id="name" placeholder="Name" required>
                                    <input class="form-control input-rounded mb-2" type="hidden" id="email" value="{{ $user->email }}">
    ...
    function saveNow(){
            ...
            $.ajax({
                ...
                success: function (data) {
                    $("#loader").html('<div class="alert alert-success">' + name + ' Added to signature lists.</div>');
                },
